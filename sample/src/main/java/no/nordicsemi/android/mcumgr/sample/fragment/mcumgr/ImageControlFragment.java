...
import no.nordicsemi.android.mcumgr.response.suit.KnownRole;
import no.nordicsemi.android.mcumgr.response.suit.McuMgrManifestStateResponse;
import no.nordicsemi.android.mcumgr.sample.R;
import no.nordicsemi.android.mcumgr.sample.databinding.FragmentCardImageControlBinding;
...
import no.nordicsemi.android.mcumgr.sample.dialog.SelectImageDialogFragment;
