...
class TaskStatsHandler : Handler {
    ...
    internal var taskStats: MutableMap<String, System.TaskStatsResponse.Task> = mutableMapOf()
...
class MemoryPoolStatsHandler : Handler {
    ...
    internal var memoryPoolStats: MutableMap<String, System.MemoryPoolStatsResponse.MemoryPool> = mutableMapOf()
